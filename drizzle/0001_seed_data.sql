...
-- insert into scheduling.schedules ("function_name", "run_datetime", "run_interval_minutes", "last_run_datetime") values ('updateAdaPrice', null, 1, date_trunc('month', now() at time zone 'utc'));
-- insert into scheduling.schedules ("function_name", "run_datetime", "run_interval_minutes", "last_run_datetime") values ('updateAvaxPrice', null, 1, date_trunc('month', now() at time zone 'utc'));
-- insert into scheduling.schedules ("function_name", "run_datetime", "run_interval_minutes", "last_run_datetime") values ('updateBtcPrice', null, 1, date_trunc('month', now() at time zone 'utc'));
